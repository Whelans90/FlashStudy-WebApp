...
public class JDBCUserDAO implements UserDAO {
	...
	public void saveUser(String email, String userName, String password) {
		...
		jdbcTemplate.update("INSERT INTO app_user(email, user_name, password, salt) VALUES (?, ?, ?, ?);",
				email, userName, hashedPassword, saltString);
	}
	...
	public void updatePassword(String userName, String password) {
		...
		jdbcTemplate.update("UPDATE app_user SET password = ? AND salt = ? WHERE user_name = ?", hashedPassword, saltString, userName);
	}
